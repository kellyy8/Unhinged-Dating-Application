...
const std::string MEMBERS_FILE    = "/Users/kellyyu/Downloads/Unhinged/members.txt";
const std::string TRANSLATOR_FILE = "/Users/kellyyu/Downloads/Unhinged/translator.txt";
